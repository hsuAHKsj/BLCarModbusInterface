...
// 初始化静态成员变量
const std::string Motor::LIFT_MOTOR = "举升电机";
const std::string Motor::LEFT_WHEEL_MOTOR = "左驱动轮电机";
const std::string Motor::RUGHT_WHEEL_MOTOR = "右驱动轮电机";
const double Motor::LIFT_GRATING = 65535.0;
const double Motor::WHEEL_GRATING = 10000.0;
const double Motor::LIFT_REDUCTION_RATIO = 5.0;
const double Motor::WHEEL_REDUCTION_RATIO = 27.0;
const double Motor::WHEEL_MAX_RPM = 300;
const double Motor::LIFT_ZERO = 0;
const double Motor::LIFT_MAX = 0;
const double Motor::LIFT_MIN = 0;
